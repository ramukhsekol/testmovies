...
public class PopcronRestController {
	...
	public ResponseEntity<List<Movies>> getmovies(@RequestParam String pageIndex, @RequestParam String genre) throws UnirestException, UnsupportedEncodingException {
